# GT Securities Colleague Outreach Template — TestCorp AI
...
interested in artificial intelligence investments at the $2.5M raise level.

## Colleague Outreach Email

**Subject:** Investment Opportunity for Your Network — TestCorp AI

Hi [Colleague Name],

I hope you're doing well. I'm working with a client, TestCorp AI, that I think could be
a strong fit for some of the accredited investors in your network.

**Quick overview:**
- **Company:** TestCorp AI | Artificial Intelligence
- **Raising:** $2,500,000
- **Stage:** Seed/Early Growth
- **Website:** https://testcorpai.com
