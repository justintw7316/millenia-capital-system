# Alignable Account Setup Guide — EdgeCase Corp
...
2. Business name: EdgeCase Corp
3. Upload company logo and complete all profile fields
4. Add company description (use tear sheet overview)
5. Link to company website: https://edgecase.com
6. Add industry: artificial intelligence
...
- [ ] Angel Investors
- [ ] Artificial Intelligence Business Network
...
- [ ] Artificial Intelligence Startups & Investors

## Message Template for Alignable Connections

Hi [Name], I noticed you're active in the investor community on Alignable.
I'm Test Founder, founder of EdgeCase Corp — a artificial intelligence company
raising $2,500,000. Would love to connect and share what we're building.
